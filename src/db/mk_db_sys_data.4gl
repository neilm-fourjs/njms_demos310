...
FUNCTION insert_system_data()
	...
	CALL addMenu("demo","main","F","Wizard SD","wizard1_sd.42r","")
	CALL addMenu("demo","main","F","Wizard MD","wizard2_md.42r","")
	CALL addMenu("demo","main","F","Wizard MRS","wizard3_mrs.42r","")
	CALL addMenu("demo","main","F","Wizard DnD","wizard4_dnd.42r","")
