...
FUNCTION gl_about(l_ver STRING) --{{{
  ...
  IF gl_app_name IS NULL THEN
    CALL gl_setAppInfo(NULL, NULL)
  END IF

  OPEN WINDOW about AT 1, 1 WITH 1 ROWS, 1 COLUMNS ATTRIBUTE(STYLE = "naked")
  LET n = gl_lib_aui.gl_getWinNode(NULL)
  CALL n.setAttribute("text", gl_progdesc)
  LET f = gl_lib_aui.gl_genForm("about")
  ...
  IF gl_app_build IS NOT NULL THEN
    ...
    CALL gl_lib_aui.gl_addLabel(g, 10, y, gl_app_name || " - " || gl_app_build, NULL, NULL)
    LET y = y + 1
  END IF

  CALL gl_lib_aui.gl_addLabel(g, 0, y, LSTR("Program") || ":", "right", "black")
  CALL gl_lib_aui.gl_addLabel(g, 10, y, gl_progname || " - " || l_ver, NULL, "black")
  LET y = y + 1

  CALL gl_lib_aui.gl_addLabel(g, 0, y, LSTR("Description") || ":", "right", "black")
  CALL gl_lib_aui.gl_addLabel(g, 10, y, gl_progdesc, NULL, "black")
  LET y = y + 1

  CALL gl_lib_aui.gl_addLabel(g, 0, y, LSTR("Author") || ":", "right", "black")
  CALL gl_lib_aui.gl_addLabel(g, 10, y, gl_progauth, NULL, "black")
  LET y = y + 1
  ...
  CALL gl_lib_aui.gl_addLabel(g, 10, y, gver, NULL, "black")
  LET y = y + 1

  CALL gl_lib_aui.gl_addLabel(g, 0, y, LSTR("Server OS") || ":", "right", "black")
  CALL gl_lib_aui.gl_addLabel(g, 10, y, gl_os, NULL, "black")
  LET y = y + 1

  CALL gl_lib_aui.gl_addLabel(g, 0, y, LSTR("Server Name") || ":", "right", "black")
  CALL gl_lib_aui.gl_addLabel(g, 10, y, servername, NULL, "black")
  LET y = y + 1

  CALL gl_lib_aui.gl_addLabel(g, 0, y, LSTR("OS User") || ":", "right", "black")
  CALL gl_lib_aui.gl_addLabel(g, 10, y, gl_userName, NULL, "black")
  LET y = y + 1

  CALL gl_lib_aui.gl_addLabel(g, 0, y, LSTR("Server Time:") || ":", "right", "black")
  CALL gl_lib_aui.gl_addLabel(g, 10, y, TODAY || " " || TIME, NULL, "black")
  LET y = y + 1

  CALL gl_lib_aui.gl_addLabel(g, 0, y, LSTR("Database Name") || ":", "right", "black")
  CALL gl_lib_aui.gl_addLabel(g, 10, y, fgl_getenv("DBNAME"), NULL, NULL)
  LET y = y + 1

  CALL gl_lib_aui.gl_addLabel(g, 0, y, LSTR("Database Type") || ":", "right", "black")
  CALL gl_lib_aui.gl_addLabel(g, 10, y, upshift(fgl_db_driver_type()), NULL, "black")
  LET y = y + 1

  CALL gl_lib_aui.gl_addLabel(g, 0, y, LSTR("DBDATE") || ":", "right", "black")
  CALL gl_lib_aui.gl_addLabel(g, 10, y, fgl_getenv("DBDATE"), NULL, "black")
  LET y = y + 1
  ...
  MENU "Options"
    ...
    ON ACTION closeabout
      EXIT MENU
    ON ACTION showenv
      CALL gl_lib_aui.gl_showEnv()
    ON ACTION showreadme
      CALL gl_lib_aui.gl_showReadMe()
    ON ACTION showlicence
      CALL gl_lib_aui.gl_showlicence()
    ON ACTION copyabout
