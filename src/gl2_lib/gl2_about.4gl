...
FUNCTION gl2_about(l_appInfo appInfo INOUT)
  ...
  CALL gl2_lib_aui.gl2_addLabel(g, 10, y, l_appInfo.progdesc, NULL, "black")
  LET y = y + 1

  CALL gl2_lib_aui.gl2_addLabel(g, 0, y, LSTR("Author") || ":", "right", "black")
  CALL gl2_lib_aui.gl2_addLabel(g, 10, y, l_appInfo.progauth, NULL, "black")
  LET y = y + 1
  ...
  CALL gl2_lib_aui.gl2_addLabel(g, 0, y, LSTR("Genero Runtime") || ":", "right", "black")
  CALL gl2_lib_aui.gl2_addLabel(g, 10, y, gver, NULL, "black")
  LET y = y + 1

  CALL gl2_lib_aui.gl2_addLabel(g, 0, y, LSTR("Server OS") || ":", "right", "black")
  CALL gl2_lib_aui.gl2_addLabel(g, 10, y, l_appInfo.os, NULL, "black")
  LET y = y + 1
  ...
  CALL gl2_lib_aui.gl2_addLabel(g, 10, y, TODAY || " " || TIME, NULL, "black")
  LET y = y + 1

  CALL gl2_lib_aui.gl2_addLabel(g, 0, y, LSTR("Database Name") || ":", "right", "black")
  CALL gl2_lib_aui.gl2_addLabel(g, 10, y, fgl_getEnv("DBNAME"), NULL, NULL)
  LET y = y + 1

  CALL gl2_lib_aui.gl2_addLabel(g, 0, y, LSTR("Database Type") || ":", "right", "black")
  CALL gl2_lib_aui.gl2_addLabel(g, 10, y, UPSHIFT(fgl_db_driver_type()), NULL, "black")
  LET y = y + 1

  CALL gl2_lib_aui.gl2_addLabel(g, 0, y, LSTR("DBDATE") || ":", "right", "black")
  CALL gl2_lib_aui.gl2_addLabel(g, 10, y, fgl_getEnv("DBDATE"), NULL, "black")
  LET y = y + 1
  ...
  CALL gl2_lib_aui.gl2_addLabel(g, 10, y, l_appInfo.cli_un, NULL, "black")
  LET y = y + 1
  ...
  IF l_appInfo.cli_dir.getLength() > 1 THEN
    ...
    CALL gl2_lib_aui.gl2_addLabel(g, 10, y, l_appInfo.cli_dir, NULL, "black")
    LET y = y + 1
  END IF

  CALL gl2_lib_aui.gl2_addLabel(g, 0, y, LSTR("Screen Resolution") || ":", "right", "black")
  CALL gl2_lib_aui.gl2_addLabel(g, 10, y, l_appInfo.cli_res, NULL, "black")
  LET y = y + 1
  ...
  MENU "Options"
    ...
    ON ACTION closeabout
      EXIT MENU
    ON ACTION showenv
      CALL gl2_lib_aui.gl2_showEnv()
    ON ACTION showreadme
      CALL gl2_lib_aui.gl2_showReadMe()
    ON ACTION showlicence
      CALL gl2_lib_aui.gl2_showlicence()
    ON ACTION copyabout
