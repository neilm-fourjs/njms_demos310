...
FUNCTION gl2_about(l_ver STRING)
	...
	CALL gl2_lib_aui.gl2_addLabel(g,10,y,fgl_getEnv("DBNAME"),NULL,NULL) LET y = y + 1

	CALL gl2_lib_aui.gl2_addLabel(g, 0,y,LSTR("Database Type")||":","right","black")
	CALL gl2_lib_aui.gl2_addLabel(g,10,y,UPSHIFT( fgl_db_driver_type() ),NULL,"black") LET y = y + 1

	CALL gl2_lib_aui.gl2_addLabel(g, 0,y,LSTR("DBDATE")||":","right","black")
	CALL gl2_lib_aui.gl2_addLabel(g,10,y,fgl_getEnv("DBDATE"),NULL,"black") LET y = y + 1
	...
	MENU "Options"
		...
		ON ACTION showenv CALL gl2_lib_aui.gl2_showEnv()
		ON ACTION showreadme CALL gl2_lib_aui.gl2_showReadMe()
		ON ACTION showlicence CALL gl2_lib_aui.gl2_showlicence()
		ON ACTION copyabout 
